...
import 'package:movie_marks/presentation/components/button_item_loading.dart';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemCount: state.status == HomeStatus.initial
                            ? 5
                            : state.listGenres?.length ?? 0,
                    ...
                    if (state.listMovies?.isEmpty ??
                        true && state.status != HomeStatus.initial)
                      Expanded(
                        child: Center(
                          child: CustomTitle(
                      ...
                      Expanded(
                        child: LazyLoadScrollView(
                          ...
                          isLoading: state.status == HomeStatus.initial,
                          child: Container(
